...
- Die Positionierung der Node erfolgt auf die Position auf die der User mit der Maus klickt nachdem das Modal geschlossen wird.
...
- Mit Export und Import soll der Graf gespeichert und geladen werden.

Folgende Probleme bestehen immer noch: 
- Das Modal öffnet sich nicht wenn ein Doppelklick auf die Node erfolgt.
- Das Erscheinungsbild von ConcatNode ist nicht wie gewünscht. Es soll auch die Farbe haben wie AddNode.
