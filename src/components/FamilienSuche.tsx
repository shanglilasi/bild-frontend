...
export default function FamilienSuche() {
  const { familienStore, suchStore } = useStore()
  const [query, setQuery] = useState('')
  const treffer = familienStore.treffer
  ...
  return (
    <div className="space-y-2 text-sm">
      ...
      />
      <button onClick={handleSearch} className="w-full bg-blue-600 text-white py-1 rounded">
        🔍 Suchen
      </button>
